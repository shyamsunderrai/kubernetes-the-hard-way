...
wget -q --show-progress --https-only --timestamping \
  "https://github.com/coreos/etcd/releases/download/v3.5.4/etcd-v3.5.4-linux-arm64.tar.gz"
```
...
```
{
  tar -xvf etcd-v3.5.4-linux-arm64.tar.gz
  sudo mv etcd-v3.5.4-linux-arm64/etcd* /usr/local/bin/
}
```
